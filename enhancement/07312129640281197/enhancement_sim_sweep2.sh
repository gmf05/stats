#\!/bin/bash
unset DISPLAY
#Sun Jul 31 21:29:38 EDT 2016
matlab -nodisplay -singleCompThread -r "cd ..; addpath('/usr3/graduate/gfiddy/Code/matlab'); addpath('/usr3/graduate/gfiddy/Code/git/pp_tools'); run('/usr3/graduate/gfiddy/Code/git/mgh/mghtools'); pp_tools(); global TASK NTASKS; TASK = str2num(getenv('MATLAB_TASK')); NTASKS = str2num(getenv('MATLAB_NTASKS')); run('enhancement_sim_sweep2'); exit"

# matlab script enhancement_sim_sweep2.m at time of execution
: <<'COMMENT'
% --- enhancement_sim_sweep2.m : Sun Jul 31 21:29:38 EDT 2016 --- 
